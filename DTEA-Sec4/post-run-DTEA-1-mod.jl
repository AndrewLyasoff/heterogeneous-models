...
# not needed if run-DTEA-1-mod.jl
@time begin
    ...
    include("ini-setup-DTEA-1-mod.jl"); # include("ini-setup-DTEA-1-mod.jl") to change β from original
...
# not needed if run-DTEA-1-mod.jl
out2=deserialize("output-DTEA-1-mod.jls");
...
# plot the difference
# corresponds to the left plot in ([DTEA], Figure 15)
begin
...
#plot the difference
# corresponds to the right plot in ([DTEA], Figure 15)
begin
...
## corresponds to the left plot on ([DTEA], Figure 10)
begin
...
# corresponds to the right plot in ([DTEA], Figure 10)
begin
...
# corresponds to the left plot in ([DTEA], Figure 11)
begin
...
#corresponds to the right plot in ([DTEA], Figure 11)
begin
...
# corresponds to the left plot on ([DTEA], Figure 12)
begin
...
# corresponds to the right plot on ([DTEA], Figure 12)
begin
...
# corresponds to the left plot on ([DTEA], Figure 13)
begin
...
# corresponds to the right plot on ([DTEA], Figure 13)
begin
...
# provides the left plot on ([DTEA], Figure 16)
begin
...
# # provides the right plot on ([DTEA], Figure 16)
begin
