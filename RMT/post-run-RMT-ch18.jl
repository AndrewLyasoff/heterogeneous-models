...
#
# This code supplements the paper "Another look at some classical heterogeneous agnet models" (DIW)
#                                        by Andrew Lyasoff
#
...
# first part of Figure 3 Left in DIW
begin
...
#second part of Figure 3 Left in DIW
begin
...
# first part of Figure 3 Right in DIW
begin
    @gp aassets[1,2:LgX] LF[1][2:LgX] "w l t '' dashtype '-  -  ' lw 2.25 lt rgb 'black'";
...
#second part of Figure 3 Right in DIW
begin
...
# first part of plot not included in DIW
begin
    @gp aassets[1,2:LgX] LF[1][2:LgX] "w l t '' dashtype '-  -  ' lw 2.25 lt rgb 'black'";
