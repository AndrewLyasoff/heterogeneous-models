...
@time begin
    ...
    include("functions-SATHA-3.jl");
    include("ini-setup-SATHA-3.jl"); # include("ini-setup-SATHA-2-mod.jl") to change β from original
...
#   4.390762 seconds (33.99 M allocations: 1.497 GiB, 5.84% gc time, 1286.71% compilation time)
...
#    3.544182 seconds (219.97 M allocations: 8.503 GiB, 24.23% gc time, 407.29% compilation time)
...
#170.411675 seconds (14.80 G allocations: 551.216 GiB, 32.96% gc time)
...
=#
serialize("output-SATHA-3.jls", out2);
