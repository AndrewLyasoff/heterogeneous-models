...
@time begin
    ...
    include("ini-setup-SATHA-mod.jl");  # changes β in the original "ini-setup-SATHA-2.jl"
...
#   4.434544 seconds (34.06 M allocations: 1.499 GiB, 6.83% gc time, 1274.19% compilation time)
...
#    3.595947 seconds (221.55 M allocations: 8.564 GiB, 24.16% gc time, 409.82% compilation time)
...
# 115.518622 seconds (9.98 G allocations: 371.266 GiB, 32.76% gc time)
...
=#
serialize("output-SATHA-mod.jls", out2);
