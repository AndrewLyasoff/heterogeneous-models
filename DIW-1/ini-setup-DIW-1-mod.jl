...
#transition probabilities borrowed from the FORTRAN code of KS
...
function pos(j::Int64,l::Int64)
    return findfirst(isequal((j,l)),astatesi)
end

PJL=[sspm[pos(j,l)]/sspa[l]  for j=1:2,l=1:2]
