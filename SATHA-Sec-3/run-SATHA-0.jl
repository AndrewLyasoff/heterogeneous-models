...
begin
    ...
    c_high=FindUpperC(nos,SPOT,invH,CPROB,inc,ι,R,β);
...
@time no_iter, conv_check, conv_check_c, clearing, upper_bb, F, Fval, θ, invH, SPOT, cnext, invcnext, g_step, gsz, sol, accu0, accu, ANSATZ, CLR=find_equil(nos,0,235,0.00001,g_step,gsz,θ,invH,SPOT,CPROB,inc,BSP,ι,R,549,299,199,β);
# 8114.527882 seconds (182.17 G allocations: 8.445 TiB, 12.72% gc time, 0.08% compilation time)
...
begin
    ...
    serialize("output-SATHA-0.jls", saved_vals); #dump to a file
end;
