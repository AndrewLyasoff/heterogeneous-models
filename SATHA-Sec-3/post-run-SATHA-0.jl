...
#=
If output-SATHA-0.jls is available, there is no need for run-SATHA-0.jl 
=#

# this block is superfluous if run-SATHA-0.jl
begin
...
# this block is superfluous if run-SATHA-0.jl
begin
    saved_vals=deserialize("output-SATHA-0.jls");
    SPOT=saved_vals[end]
...
[F[i](0.000001) for i=1:nos]
#=
7-element Vector{Float64}:
  4.884491653770909e-10
 -2.063148857753425e-13
 -2.242021716493819e-17
  3.150091817330805e-21
 -5.691663531173769e-24
  1.7143122381963945e-26
  1.0090466622731266e-28
=#
...
begin
    ...
    pval=[FWX[1](x) for x in plotgrid];
    @gp :- plotgrid pval "w p lt rgb 'black' pt 7 ps 0.75 t ''";
    for i=2:length(FWX)
        local pplotgrid,ppval
        pplotgrid=(ran_w_erange[i][1]):.01:-0.6;
        ppval=[FWX[i](x) for x in pplotgrid];
        @gp :- pplotgrid ppval "w p lt rgb 'black' pt 7 ps 0.75 t ''";
    end
end
...
begin
    ...
    pval=[FWX[1](x) for x in plotgrid];
    @gp plotgrid pval "w p lt rgb 'black' pt 7 ps 0.85 t ''";#"w l t '' lw 1.5 lt rgb 'black'";
    for i=2:length(FWX)
        local pplotgrid, ppval
        pplotgrid=ran_w_erange[i][1]:.05:3.5;
        ppval=[FWX[i](x) for x in pplotgrid];
        @gp :- pplotgrid ppval "w p lt rgb 'black' pt 7 ps 0.85 t ''";#"w l t '' lw 1.5 lt rgb 'black'";
    end
    for i=1:length(FW)
        local pplotgrid,ppval
        pplotgrid=ran_w_erange[i][1]:.004:3.5;
        ppval=[FW[i](x) for x in pplotgrid];
        @gp :- pplotgrid ppval "w l t '' lw 1.75 lt rgb 'black'";
    end
end
...
begin
    ...
    @gp plotgrid pval "w l t '' lw 1.85 lt rgb 'black'";
    for i=2:length(FWX)
        local pplotgrid, ppval
...
begin
    ...
    @gp plotgrid pval "w l t '' lw 1.0 lt rgb 'black'";
    for i=2:length(F)
        local ppval
        ppval=[θ[i](x)*SPOT for x in plotgrid];
        @gp :- plotgrid ppval "w l t '' lw 1.0 lt rgb 'black'";
     end
end
...
begin
    ...
    pval=[θ[1](x)*SPOT for x in plotgrid];
    @gp plotgrid pval "w l t '' lw 0.9 lt rgb 'black'";
    for i=2:length(F)
        local ppval
        ppval=[θ[i](x)*SPOT for x in plotgrid];
        @gp :- plotgrid ppval "w l t '' lw 0.9 lt rgb 'black'";
     end
end
...
begin
    ...
    for i=2:length(F)
        local ppval
        ppval=[θ[i](x)*SPOT for x in plotgrid];
        @gp :- plotgrid ppval "w l t '' lw 1.5 lt rgb 'black'";
     end
end
...
begin
    ...
    @gp plotgrid pval "w l t '' lw 2.0 lt rgb 'black'";
    for j=2:nos
        local pplotgrid,ppval
        pplotgrid=ran_w_range_next[1,j][1]:.001:3;
        ppval=[cnw_spline[1,j](x) for x in pplotgrid];
        @gp :- pplotgrid ppval "w l t '' lw 2.0 lt rgb 'black'";
    end
end
...
begin
    ...
    @gp :- plotgrid pval "w p lt rgb 'black' pt 7 ps 0.85 t ''";
    for j=2:nos
        local pplotgrid,ppval
        pplotgrid=ran_w_range_next[7,j][1]:.05:3;
        ppval=[cnw_spline[7,j](x) for x in pplotgrid];
        @gp :- pplotgrid ppval "w p lt rgb 'black' pt 7 ps 0.85 t ''";
    end
end
...
begin
    ...
    for i=2:length(F)
        ...
        @gp :- plotgrid ppval "w l t '' lw 2.0 lt rgb 'black'";
    end
end
...
begin
    ...
    for i=2:length(F)
        ...
        @gp :- plotgrid ppval "w p lt rgb 'black' pt 7 ps 0.85 t ''";
    end
end
...
[ran_w_crange[i][end] for i=1:nos]

[ran_w_crange[i][1] for i=1:nos]
...
begin
    ...
    @gp plotgrid pval "w l t '' lw 1.75 lt rgb 'black'";
    for i=2:length(FW)
        local pplotgrid, ppval
...
begin
    grdcc=cgrid[1]:0.00025:(cgrid[1]+1999*0.00025);
    grdccx=cgrid[1]:0.00025:(cgrid[1]+2000*0.00025);
    grdaax=[x+θ[k](x)*SPOT-wage*hours[k] for k=1:7, x in grdccx];
    grdaat=[x+θ[k](x)*SPOT-wage*hours[k] for k=1:7, x in (grdcc+grdccx[2:end])*(1/2)];
    true_dist=[(FW[k](grdaax[k,i])-FW[k](grdaax[k,i-1]))*BSP[k] for k=1:7, i=2:2001];
end;
=#
...
begin
    ...
    @gp :- aassetst[2,1:10:1300] LFt[2][1:10:1300] "w l t '' lw 1.75 lt rgb 'black'";#"w p lt rgb 'black' pt 7 ps 0.75 t ''";
    @gp :- aassetst[3,1:10:1300] LFt[3][1:10:1300] "w l t '' lw 1.75 lt rgb 'black'";#"w p lt rgb 'black' pt 7 ps 0.75 t ''";
    @gp :- aassetst[4,1:10:1300] LFt[4][1:10:1300] "w l t '' lw 1.75 lt rgb 'black'";#"w p lt rgb 'black' pt 7 ps 0.75 t ''";
    @gp :- aassetst[5,1:10:1300] LFt[5][1:10:1300] "w l t '' lw 1.75 lt rgb 'black'";#"w p lt rgb 'black' pt 7 ps 0.75 t ''";
    @gp :- aassetst[6,1:10:1300] LFt[6][1:10:1300] "w l t '' lw 1.75 lt rgb 'black'";#"w p lt rgb 'black' pt 7 ps 0.75 t ''";
    @gp :- aassetst[7,1:10:1300] LFt[7][1:10:1300] "w l t '' lw 1.75 lt rgb 'black'";#"w p lt rgb 'black' pt 7 ps 0.75 t ''";
end
...
begin
    ...
    pval=[FWX[1](x) for x in plotgrid];
    @gp :- plotgrid pval "w p lt rgb 'black' pt 7 ps 0.85 t ''";#"w l t '' lw 2.5 lt rgb 'black'";
     for i=2:length(FW)
        local pplotgrid,ppval
         pplotgrid=aassetst[i,1]:.05:aassetst[i,1300];
         ppval=[FWX[i](x) for x in pplotgrid];
        @gp :- pplotgrid ppval "w p lt rgb 'black' pt 7 ps 0.85 t ''";#"w l t '' lw 2.5 lt rgb 'black'";
    end
end
